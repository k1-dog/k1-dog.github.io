...
import { CSSProperties, ComponentInternalInstance, PropType, defineComponent, getCurrentInstance, h, onMounted, onUnmounted } from 'vue'
...
export const M9WebAdaptor = (function () {
  ...
  setup () {
    ...
    function bootSniffer () {
      ...
      // console.log('🚀 ~ bootSniffer ~ targetElement:', targetElement)
      start(targetElement)
    }
    ...
    function compile ($m9WebDOM: Element): void | [Element, null | object] {
      ...
      function c_m9_web_sourceElement ($String) {
        ...
        let _sElement: Element | null = null
        if (!$m9WebSourceID) {
          _sElement = $m9WebDOM
        } else {
