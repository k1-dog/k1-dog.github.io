  ...
  class Bar extends M9Element { // extends M9Element
    ...
    __Bar__(Interactor: InteractorClassT) {
      ...
      Interactor._interactions.forEach((__interaction) => {
        ...
        Interactor._StartAnimation_(__interaction, { startState: _startState, endState: _endState, beforeAnimating: _beforeAnimating, ctxWithCurrentState: _ctxWithCurrentState, isStop: _isStop, calcNextState: _calcNextState })
      })
    }
