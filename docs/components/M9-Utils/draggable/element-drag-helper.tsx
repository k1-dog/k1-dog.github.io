...
import { defineComponent, createApp, ref, computed, reactive, onBeforeMount, onBeforeUnmount, PropType } from "vue"
...
function M9DragHelperCtor () {
  ...
  return (props) => one_m9DragHelper = one_m9DragHelper || createApp(M9DragHelperComponent, {
